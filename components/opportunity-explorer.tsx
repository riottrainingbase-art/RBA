...
const copy={
  ja:{title:"次の育成機会を、ここで見つける。",lead:"日程、地域、対象年代、内容、参加費、募集状況を見比べて、そのまま公式申込へ進めます。",filter:"条件を選ぶ",region:"地域",age:"対象",kind:"目的",all:"すべて",results:"件の募集中プログラム",empty:"条件に合う募集中の活動はありません。条件を変えてお探しください。",open:"募集中",date:"日程",place:"地域・会場",target:"対象",fee:"参加費",detail:"詳しく見る",apply:"公式申込へ",payment:"申込・決済案内",join:"RBA IDで次の機会につなぐ",joinBody:"参加後の記録、次のおすすめ、育成コンテンツをMY HOME COURTへつなげます。",regions:{tohoku:"東北",kanto:"関東",kansai:"関西",kyushu:"九州",okinawa:"沖縄",online:"オンライン"}},
