...
export const worldPoints:MapPoint[]=[
 ...
 {id:"dubai",lon:55.27,lat:25.20,name:["Dubai · UAE","UAE・ドバイ","阿聯・杜拜","UAE・두바이"],status:"partner",detail:["Hangtime Basketball · verified coach learning and exchange relationship.","Hangtime Basketball。指導者の学びと交流に向けた確認済み連携。","Hangtime Basketball；已確認的教練學習與交流合作。","Hangtime Basketball. 코치 학습과 교류를 위한 확인된 협력."]},
 {id:"korea",lon:126.71,lat:37.46,name:["Incheon · South Korea","韓国・仁川","韓國・仁川","대한민국・인천"],status:"discussion",detail:["MVP Basketball Academy · discussions; not a completed programme.","MVP Basketball Academy。協議中。実施済み実績ではありません。","MVP Basketball Academy；協議中，非已完成活動。","MVP Basketball Academy. 협의 중이며 완료 실적이 아닙니다."]},
];
