...
const copy = {
  ...
  ja: { title:"もうひとつ、ホームコートを。", lead:"プレーする人も、応援する人も、教える人も。全国のクリニックや学び、仲間との出会いを通じて、バスケットボールの楽しみ方が広がる場所です。登録は無料。今のチームを辞める必要も、何かを買う必要もありません。", join:"RBA IDでログイン", free:"無料でRBA IDをつくる", start:"MY HOME COURTを開く", price:"RBA HOMECOURT 月額", note:"参加条件と料金は、各プログラムの申込時にご確認ください。", included:"MY HOME COURTでできること", includedBody:"一度きりの参加で終わらず、次の活動や学びにつなげながら、自分の成長を記録していく場所です。", steps:"利用開始までの流れ", stepItems:[["01","自分に合うページを選ぶ","PLAYER／PARENT／COACHから、自分の立場に合った案内を確認します。"],["02","RBA IDで始める","活動情報や育成に役立つ学び、コミュニティのお知らせを確認できます。"],["03","次の活動を見つける","クリニックや交流活動の予定を見ながら、次に挑戦したいことを探しましょう。"]], safe:"決済情報・個人情報の取り扱い", safeBody:"カード情報はStripeの決済画面で入力・管理されます。お子さまの健康情報や非公開の写真は、一般のお問い合わせフォームから送信しないでください。" },
