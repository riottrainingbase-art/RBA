...
const copy = {
  ...
  ja: { title:"もうひとつ、ホームコートを。", lead:"選手も、保護者も、指導者も。全国のクリニックや学び、新しい仲間との出会いを通じて、バスケットボールの選択肢を広げられる場所です。登録は無料。今のチームに所属したまま利用できます。", join:"RBA IDでログイン", free:"無料でRBA IDをつくる", start:"MY HOME COURTを開く", price:"RBA HOMECOURT 月額", note:"参加条件と料金は、各プログラムの申込時にご確認ください。", included:"MY HOME COURTでできること", includedBody:"一度の参加で終わらせず、次の活動や学びにつなげながら、自分の経験と成長を記録していく場所です。", steps:"利用開始までの流れ", stepItems:[["01","自分に合うページを選ぶ","PLAYER／PARENT／COACHから、自分の立場に合った案内を確認します。"],["02","RBA IDで始める","活動情報や育成に役立つ学び、コミュニティのお知らせを確認できます。"],["03","次の活動を見つける","クリニックや交流活動の予定から、自分に合う次の挑戦を探せます。"]], safe:"決済情報・個人情報の取り扱い", safeBody:"カード情報はStripeの決済画面で入力・管理されます。お子さまの健康情報や非公開の写真は、一般のお問い合わせフォームから送信しないでください。" },
