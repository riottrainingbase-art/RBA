...
export function LocalizedSchedule({locale}:{locale:Locale}){
  ...
  return <div lang={locale==="zh-tw"?"zh-Hant-TW":locale}><SiteFrame locale={locale} languagePage="schedule">
    ...
    {locale==="ja"?<section className="registration-flow section-pad">
      <div><p className="section-index inverse">BEFORE YOU JOIN</p><h2>申し込む前から、もう始まっている。</h2><p>「参加する日」を待つだけではなく、どんなプレーを試したいか、何を見つけたいかを一つ決めてから来てください。</p></div>
      <div className="registration-flow-steps">
        <article><span>01</span><strong>CHOOSE</strong><p>行ってみたいコートを選ぶ。</p></article>
        ...
        <article><span>04</span><strong>KEEP</strong><p>終わったらMY HOME COURTに経験を残す。</p></article>
      </div>
    </section>:null}
