...
const words={
  ja:{title:"次の挑戦は、ここから。",lead:"クリニックでの出会いを、次の挑戦へ。MY HOME COURTから、気になる活動や学びを見つけましょう。メールアドレスで登録・ログインできます。",email:"メールアドレス",changeEmail:"メールアドレスを変更",send:"ログインリンクを送信",sent:"メールをご確認ください",sentBody:"メールのログインリンクを開いてください。見当たらない場合は迷惑メールフォルダと入力したアドレスをご確認ください。再送する場合は少し時間をおいてお試しください。",role:"最初に開くページ",terms:"参加規約とプライバシーポリシーを確認し、同意します。",termsRequired:"送信するには、参加規約とプライバシーポリシーへの同意が必要です。",player:"PLAYER",parent:"PARENT",coach:"COACH",safe:"選手も、保護者も、指導者も。バスケットボールをもっと楽しむきっかけを、ここで。",back:"MY HOME COURTへ戻る",error:"送信できませんでした。メールアドレスを確認し、もう一度お試しください。"},
