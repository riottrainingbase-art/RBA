...
const words={
  ja:{title:"RBA IDを作成する・ログインする",lead:"RBA IDは、これまでの参加履歴、これからのクリニック、保存した活動、学びを一つにつなぐ共通IDです。初めての方も、以前RBAに参加したことがある方も、メールアドレスだけで始められます。",email:"メールアドレス",changeEmail:"メールアドレスを変更",send:"ログイン用メールを送る",sent:"メールをご確認ください",sentBody:"届いたメールのリンクを開くと、RBA IDの作成またはログインが完了します。以前RBAに参加したことがある方は、参加時と同じメールアドレスを使うと、参加履歴を確認しやすくなります。",role:"あなたの立場",terms:"参加規約とプライバシーポリシーを確認し、同意します。",termsRequired:"送信するには、参加規約とプライバシーポリシーへの同意が必要です。",player:"PLAYER",parent:"PARENT",coach:"COACH",safe:"選手は自分の経験や次の活動を、保護者はお子さまの予定や履歴を、指導者はD-HUBや講習・学習履歴を確認できます。RBA ID一つで、必要な情報をまとめて確認できます。",back:"MY HOME COURTへ戻る",error:"送信できませんでした。メールアドレスを確認し、もう一度お試しください。"},
