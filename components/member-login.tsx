...
const words={
  ja:{title:"RBA IDをつくる。ログインする。",lead:"RBA IDは、過去の参加、これからのクリニック、保存した情報、学びを一つにつなぐ共通IDです。初めての方も、すでに参加したことがある方も、同じメールアドレスから始められます。",email:"メールアドレス",changeEmail:"メールアドレスを変更",send:"RBA IDを作成・ログイン",sent:"メールをご確認ください",sentBody:"届いたメールのリンクを開くと、RBA IDの作成またはログインが完了します。以前RBAに参加した方は、参加時と同じメールアドレスを使うと確認がスムーズです。",role:"あなたの立場",terms:"参加規約とプライバシーポリシーを確認し、同意します。",termsRequired:"送信するには、参加規約とプライバシーポリシーへの同意が必要です。",player:"PLAYER",parent:"PARENT",coach:"COACH",safe:"PLAYERは自分の経験を。PARENTは子どもの予定と履歴を。COACHはD-HUB・Torsten・学習履歴を。RBA IDひとつでつなぎます。",back:"MY HOME COURTへ戻る",error:"送信できませんでした。メールアドレスを確認し、もう一度お試しください。"},
