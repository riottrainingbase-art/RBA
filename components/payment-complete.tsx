...
export function PaymentComplete({locale,paymentType}:{locale:Locale;paymentType?:string}){const c=copy[locale];const membership=paymentType==="rba_homecourt";const membershipCopy={
 ...
 ja:{b:"決済時に入力したメールアドレスへ、Stripeから支払い完了メールが届きます。決済情報の照合後、MY HOME COURTのメンバーシップ利用状況に反映されます。反映に少し時間がかかる場合があります。",d:"決済済みの場合は、反映待ちの間にもう一度支払わないでください。異なるメールアドレスで決済した場合や、しばらく反映されない場合はRBAへご連絡ください。",back:"メンバーシップ反映を確認する"},
