...
const copy={
 ja:{eyebrow:"GLOBAL DEVELOPMENT PROFILE",title:"世界を見る前に、まず今の自分を知る。",lead:"興味のある地域や活動、今取り組んでいることを登録すると、MY HOME COURTで自分に合う機会を見つけやすくなります。海外プログラムへの参加や選考結果を保証する機能ではありません。",completion:"PROFILE",position:"主に取り組むポジション",stage:"今の成長段階",focus:"今、伸ばしたいこと",long:"将来、どんな選手になりたいか",year:"これから1年で挑戦したいこと",scope:"活動を探したい範囲",countries:"興味のある国・地域",languages:"興味のある言語",types:"興味のある機会",international:"海外・国際交流の情報も表示する",save:"プロフィールを保存",saved:"保存しました",privacy:"この情報は、MY HOME COURTで自分に合う機会を探しやすくするための非公開情報です。他の利用者には公開されません。",stages:{foundation:"基礎をつくる",learning:"学びを広げる",developing:"実戦で伸ばす",advanced:"高い強度へ挑戦",performance:"競技パフォーマンスを高める"},scopes:{local:"地域中心",national:"全国まで",asia:"アジアまで",global:"世界まで"},opps:{clinic:"クリニック",camp:"Development Camp",game:"ゲーム・大会",united:"RBA UNITED",exchange:"国際交流",online:"オンライン学習",coach:"指導者講習"}},
