...
export function LocalizedPayments({locale}:{locale:Locale}){
  ...
  return <SiteFrame locale={locale} languagePage="payments">
    ...
    <section className="next-page section-pad"><p>{c.apply} → {c.pay}</p><a href={localePath(locale,"policies")}>{locale==="ja"?"参加規約・キャンセル・返金方針を確認":"Terms and cancellation policy"}<ArrowRight size={24}/></a></section>
  </SiteFrame>;
}
