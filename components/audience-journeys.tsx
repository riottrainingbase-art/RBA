...
const copy={
 ...
 ja:{label:"目的別のご案内",title:"選手・保護者・コーチの方へ",intro:"立場ごとに、必要な情報と次に進むページをまとめました。",roles:[
  {icon:"players",tag:"選手",title:"参加して、学び、次の挑戦へ。",body:"見る・選ぶ・実行する力を育てるクリニック、キャンプ、3x3、クラブ活動に参加できます。",items:["仙台U12スクール：毎週土曜16:30〜18:00／旧実沢小学校／小学4〜6年生／月額6,600円","U15クラブ事業：Gream仙台、Gream沖縄、DSMとの連携","全国各地のクリニック、宿泊キャンプ、RBA UNITED、海外交流"],links:[["選手向けページを開く","players"],["MY HOME COURT｜選手","my-homecourt/players"],["募集中のプログラムを見る","schedule"]]},
  {icon:"family",tag:"保護者",title:"費用・安全面・申込方法を確認する。",body:"対象年代、参加費、費用に含まれる内容、キャンセル条件は、各企画の公式申込ページで確認できます。ご不明な点は、決済前にお問い合わせください。",items:["フォームを送信しただけでは、申込が確定しない企画があります","決済方法とキャンセル条件は、各企画の公式案内をご確認ください","健康状態、アレルギー、緊急連絡先は、運営に必要な範囲で安全に取り扱います"],links:[["保護者向けページを開く","families"],["MY HOME COURT｜保護者","my-homecourt/families"],["参加規約・安全方針を読む","policies"],["公式LINEで募集情報を受け取る",lineUrl]]},
  {icon:"coach",tag:"コーチ・指導者",title:"学び、対話し、現場へつなげる。",body:"練習設計、選手育成、S&C、海外指導者からの学びを、日々のコーチングにつなげます。",items:["トーステン・ロイブル氏オンライン指導者講習","指導者向けオープンコミュニティ","地域・チームへの出張クリニック、練習設計、指導者向け相談"],links:[["コーチ・指導者向けページを開く","coaches"],["MY HOME COURT｜指導者","my-homecourt/coaches"],["RBAコミュニティを開く","community"],["RBAの育成記事を読む",noteUrl]]}
...
function route(locale:Locale,href:string){if(href.startsWith("http"))return href;if(href.startsWith("my-homecourt/"))return `${locale==="en"?"":`/${locale}`}/${href}`;return localePath(locale,href as "schedule"|"contact"|"policies"|"events/torsten-loibl-online-clinic"|"players"|"families"|"coaches"|"community");}
