...
const copy = {
  ja: { title: "MY HOME COURTへようこそ。", message: "現在、登録・ログインメールの送信を一時停止しています。クリニックやキャンプの情報は、開催日程からご覧いただけます。参加のお申し込みやご相談は、お問い合わせ窓口へどうぞ。", back: "MY HOME COURTへ戻る", schedule: "開催日程を見る", contact: "RBAに問い合わせる", status: "メールログインについて" },
