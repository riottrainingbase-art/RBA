...
const copy={
 ja:{title:"通知・メール設定",lead:"必要な連絡と、任意の案内を分けて設定できます。",event:"申込・イベントの変更",payment:"決済・請求に関する重要なお知らせ",team:"所属チームからのお知らせ",development:"振り返り・育成記録に関するお知らせ",opportunities:"新しいクリニック・キャンプ・育成機会",marketing:"RBAからのお知らせ（任意）",channel:"優先する連絡方法",save:"設定を保存",saved:"保存しました",note:"安全に関する重要なお知らせや、決済・契約に必要な連絡は、設定にかかわらず送信する場合があります。"},
