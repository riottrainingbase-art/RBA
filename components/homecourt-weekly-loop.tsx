...
const general={
  ja:{eyebrow:"WEEKLY DEVELOPMENT LOOP",title:"今週取り組むことを、一つ決める。",lead:"一度に多くを詰め込まず、今週のテーマを一つ決めて実践し、週末に振り返ります。",reflection:"今週取り組んで、どんな変化があったか",next:"来週、続けること・変えること",save:"今週のテーマを保存",complete:"今週の振り返りを完了する",reopen:"もう一度編集する",saved:"保存しました。",error:"保存できませんでした。もう一度お試しください。",loading:"今週のテーマを読み込んでいます…",streak:"継続週数",weeks:"週",history:"最近の週",empty:"まだ完了した週はありません。"},
