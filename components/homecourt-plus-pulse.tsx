...
const copy={
  ja:{eyebrow:"PLUS / DEVELOPMENT PULSE",title:"今の1週間を、ひと目で確認する。",lead:"予定、今週のテーマ、コンディション記録、準備項目を一つにまとめます。医療判断や能力評価ではなく、自分の行動を整理するための表示です。",theme:"今週のテーマ",condition:"7日間の記録",prep:"未完了の準備",next:"次に続けること",noTheme:"今週のテーマはまだありません",noCondition:"まだ記録がありません",noPrep:"未完了の準備はありません",noNext:"次の項目はまだありません",loading:"現在の状態をまとめています…",days:"日記録",energy:"平均エネルギー",fatigue:"平均疲労",sleep:"平均睡眠"},
