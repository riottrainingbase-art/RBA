...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "RBA 所追求的 Youth Basketball Development Platform 架構：RBA Owned、Regional Host、Marketplace、Japan × Asia。",
    url: "https://riotbasketballacademy.com/zh-tw/platform",
    siteName: "Riot Basketball Academy",
    type: "website",
    images: [{ url: "https://riotbasketballacademy.com/rba-definitive/assets/og-platform.png" }],
  },
  twitter: { card: "summary_large_image", title: "RBA PLATFORM VISION | Riot Basketball Academy", description: "RBA 所追求的 Youth Basketball Development Platform 架構：RBA Owned、Regional Host、Marketplace、Japan × Asia。", images: ["https://riotbasketballacademy.com/rba-definitive/assets/og-platform.png"] },
};

export default function Page() {
  return <DefinitiveStaticPage page="platform" locale="zh-tw" />;
}
