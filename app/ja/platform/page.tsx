...
export const metadata:Metadata={
 ...
 description:"選手、保護者、指導者、チーム、主催者、海外アカデミーを、RBA ID、MY HOME COURT、育成機会、安全管理、申込・決済でつなぐプラットフォームです。",
 ...
 openGraph:{title:"RBA育成プラットフォーム | 育成を、一つの流れに。",description:"選手、保護者、指導者、チーム、主催者、海外アカデミーを、RBA ID、MY HOME COURT、育成機会、安全管理、申込・決済でつなぐプラットフォームです。",url:`https://riotbasketballacademy.com/ja/platform`,siteName:"Riot Basketball Academy",type:"website",images:[{url:"https://riotbasketballacademy.com/rba-definitive/assets/og-platform.png"}]},
 twitter:{card:"summary_large_image",title:"RBA育成プラットフォーム | 育成を、一つの流れに。",description:"選手、保護者、指導者、チーム、主催者、海外アカデミーを、RBA ID、MY HOME COURT、育成機会、安全管理、申込・決済でつなぐプラットフォームです。",images:["https://riotbasketballacademy.com/rba-definitive/assets/og-platform.png"]}
};
