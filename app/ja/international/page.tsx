...
export const metadata: Metadata = {
  ...
  description: "Japan × Asia. Friendly Game、Development Camp、Tournament、Coach Exchangeを通じて日本とアジアをつなぎます。",
  ...
  twitter: { card: "summary_large_image", title: "RBA INTERNATIONAL | Japan Basketball Exchange", description: "Japan × Asia. Friendly Game、Development Camp、Tournament、Coach Exchangeを通じて日本とアジアをつなぎます。", images: ["https://riotbasketballacademy.com/rba-definitive/assets/og-platform.png"] },
};
