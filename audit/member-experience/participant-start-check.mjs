...
function load(path,imports={}){const loadedModule={exports:{}};vm.runInNewContext(ts.transpileModule(fs.readFileSync(path,'utf8'),{compilerOptions:{module:ts.ModuleKind.CommonJS,jsx:ts.JsxEmit.ReactJSX}}).outputText,{module:loadedModule,exports:loadedModule.exports,require:k=>{if(k==='react/jsx-runtime')return jsx;if(k in imports)return imports[k];throw Error(k);}});return loadedModule.exports;}
