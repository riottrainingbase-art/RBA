...
for(const [patch,expected] of [[{},true],[{status:'trialing'},true],[{cancel_at_period_end:true},true],[{status:'canceled'},false],[{status:'past_due'},false],[{plan_key:'other'},false],[{current_period_end:null},false],[{current_period_end:'invalid'},false],[{cancel_at_period_end:true,current_period_end:null},false],[{cancel_at_period_end:true,current_period_end:'invalid'},false],[{cancel_at_period_end:true,current_period_end:'2026-09-24T12:00:00Z'},false],[{cancel_at_period_end:true,current_period_end:'2020-01-01'},false]])assert.equal(canReadMemberArticles([{...active,...patch}],now),expected);
...
console.log('PASS: 12 subscription cases, 77 public-safe article records (39 player / 36 parent / 2 coach), player+parent search/category render, private-body access controls. No network or payment writes.');
